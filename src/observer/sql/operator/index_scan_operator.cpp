...
{ 
  ...
  if (left_user_key) {
    ...
    LOG_ERROR("left_user_key_ =  %d", *(int*)left_user_key_);
    LOG_ERROR("left_user_key =  %d", *(int*)left_user_key);
    LOG_ERROR("left_user_key pointer = %p", left_user_key);
  }
  if (right_user_key) {
    right_user_key_ = (char*)malloc(total_len);
    memcpy(right_user_key_, right_user_key, total_len);
    LOG_ERROR("right_user_key_ =  %d", *(int*)right_user_key_);
    LOG_ERROR("right_user_key =  %d", *(int*)right_user_key);
    LOG_ERROR("right_user_key pointer = %p", right_user_key);
  }
}
